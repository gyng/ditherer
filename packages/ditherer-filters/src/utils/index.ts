...
// Palette mode IDs — must match PAL_MODE_* in packages/ditherer-filters/src/wasm/rgba2laba/src/lib.rs.
...
// Row-alternation IDs — must match ROW_ALT_* in packages/ditherer-filters/src/wasm/rgba2laba/src/lib.rs
// and the JS-side ROW_ALT enum in packages/ditherer-filters/src/filters/errorDiffusingFilterFactory.ts.
