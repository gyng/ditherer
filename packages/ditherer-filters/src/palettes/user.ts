...
import { rgba, colorDistance, wasmNearestLabPrecomputed } from "../utils/index";
...
export const THEMES: Record<string, number[][]> = {
  ...
  TRS80: [rgba(0, 0, 0, 255), rgba(0, 255, 0, 255)],
...
export const THEME_CATEGORIES: Record<string, Array<{ key: string; desc: string }>> = {
  ...
  "Animated Knockoffs": [
    {
      key: "BATHHOUSE_BUBBLEBATH",
      desc: "Ghostly spa day — powder pinks, porcelain neutrals, misty blue",
    },
    ...
    {
      key: "BIGFUZZY_CAMPHOLLOW",
      desc: "Forest creature campfire — bark brown, slate blue, soot gray",
    },
    {
      key: "BIGFUZZY_PILLOWFORT",
      desc: "Gentle giant nap palette — mushroom gray, denim, oatmeal",
    },
    {
      key: "BIGFUZZY_RAINYPATH",
      desc: "Umbrella walk through the woods — wet stone, chestnut, faded blue",
    },
    {
      key: "BROOMCOURIER_MIDNIGHTDROP",
      desc: "After-hours delivery run — plum red, harbor teal, cocoa",
    },
    {
      key: "BROOMCOURIER_PASTRYBOX",
      desc: "Bakery window charm — blush pink, sky blue, frosted cream",
    },
    {
      key: "BROOMCOURIER_SIGNPAINT",
      desc: "Small-town shopfront — poster red, painted blue, warm kraft paper",
    },
    {
      key: "HARVEST_MEMOIR_AFTERNOON",
      desc: "Country scrapbook in summer — leaf green, cloud blue, sunflower",
    },
    {
      key: "HARVEST_MEMOIR_DAYBOOK",
      desc: "Memory album washed in daylight — sage, butter, schoolbook blue",
    },
    { key: "HARVEST_MEMOIR_DUSK", desc: "Evening farm road — inky blue, moss, dim lantern gold" },
    {
      key: "MARINA_MANOR_AFTER_DARK",
      desc: "Seaside mystery after curfew — pine black, wine, deep harbor teal",
    },
    {
      key: "MARINA_MANOR_MIST",
      desc: "Coastal manor morning fog — faded rose, sea glass, antique cream",
    },
    { key: "MARINA_MANOR_MOODY", desc: "Salt-air drama — mahogany, petrol blue, sanded brass" },
    {
      key: "SALTSPRITE_ABYSSBUBBLE",
      desc: "Deep tide fantasy — kelp shadow, coral ember, anchor rust",
    },
    {
      key: "SALTSPRITE_CANDYFOAM",
      desc: "Bubblegum shoreline — sherbet pink, aqua, seashell beige",
    },
    {
      key: "SALTSPRITE_TIDEPOP",
      desc: "Sunlit surf chaos — candy coral, sea blue, goldfish yellow",
    },
    {
      key: "SKYCASTLE_ENGINE_ROOM",
      desc: "Ancient flying machine at night — indigo steel, brass, smoke",
    },
    {
      key: "SKYCASTLE_POSTCARD",
      desc: "Floating-island postcard — lavender stone, cloud blue, parchment gold",
    },
    {
      key: "SKYCASTLE_STORMSIGNAL",
      desc: "Adventure serial sky chase — ultramarine, orchid, beacon gold",
    },
    { key: "WOLFSHADOW_BLUSH", desc: "Mythic forest dawn — clay pink, mist blue, pale amber" },
    {
      key: "WOLFSHADOW_EMBERROOT",
      desc: "Ash-and-cedar night hunt — charcoal, ember orange, bog green",
    },
    {
      key: "WOLFSHADOW_IRONBARK",
      desc: "Ancient woodland conflict — iron blue, bark brown, signal red",
    },
  ],
  "Art & Design": [
  ...
  "Regional & Cultural": [
    ...
    {
      key: "PERSIAN_MINIATURE",
      desc: "Manuscript illumination — lapis, turquoise, gold, vermillion",
    },
  ...
  "Digital & Interface": [
    {
      key: "DOS_NAVIGATOR",
      desc: "Norton Commander — blue background, cyan text, yellow highlight",
    },
...
const getColor = (color: number[], options: UserPaletteOptions = defaults): number[] => {
