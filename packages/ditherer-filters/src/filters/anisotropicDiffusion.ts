...
export const optionTypes = {
  ...
  kappa: { type: RANGE, range: [1, 200], step: 1, default: 30, desc: "Edge threshold — lower preserves weaker edges; higher smooths across stronger transitions" },
...
const anisotropicDiffusion = (input: any, options: Partial<typeof defaults> = defaults) => {
  ...
  const conductance = options.conductance === CONDUCTANCE_QUADRATIC
    ? CONDUCTANCE_QUADRATIC
    : CONDUCTANCE_EXP;
