...
export const optionTypes = {
  ...
  steps: {
    ...
    step: 1,
    default: 10,
    desc: "Reaction-diffusion steps per frame",
  },
  mode: {
    type: ENUM,
    options: [
  ...
  reseed: {
    ...
    step: 1,
    default: 0,
    desc: "Reseed B from source every N frames (0 = never)",
  },
...
export default defineFilter({
  ...
  defaults,
  description:
    "Gray-Scott reaction-diffusion seeded from image luminance — spots, stripes, coral, mitosis, labyrinth Turing patterns grow out of the picture over time",
