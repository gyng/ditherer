...
export const optionTypes = {
  rr: {
    ...
    step: 0.05,
    default: 1,
    desc: "Red contribution to output red",
  },
  rg: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 0,
    desc: "Green contribution to output red",
  },
  rb: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 0,
    desc: "Blue contribution to output red",
  },
  gr: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 0,
    desc: "Red contribution to output green",
  },
  gg: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 1,
    desc: "Green contribution to output green",
  },
  gb: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 0,
    desc: "Blue contribution to output green",
  },
  br: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 0,
    desc: "Red contribution to output blue",
  },
  bg: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 0,
    desc: "Green contribution to output blue",
  },
  bb: {
    type: RANGE,
    range: [-1, 2],
    step: 0.05,
    default: 1,
    desc: "Blue contribution to output blue",
  },
