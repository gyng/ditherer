...
export const optionTypes = {
  ...
  motionAngle: {
    ...
    step: 1,
    default: 0,
    desc: "Motion-blur direction (degrees)",
  },
  noise: {
    type: RANGE,
    range: [0.0001, 0.5],
    step: 0.0001,
    default: 0.01,
    desc: "Wiener noise damping λ — higher avoids amplifying noise, lower gives sharper result",
  },
...
export default defineFilter({
  ...
  defaults,
  description:
    "Wiener deconvolution against a built-in Gaussian or motion-blur kernel — undoes blur up to the noise-damping limit",
