...
export const filterList = [
  ...
  { displayName: "Posterize dither", filter: posterizeDither, category: "Dithering", description: "Tone-preserving per-channel Bayer dithering between configurable output levels" },
  { displayName: "Median Cut", filter: medianCut, category: "Dithering", description: "Build an exact-budget adaptive palette from visible pixels and remap the image to it" },
  ...
  { displayName: "CLAHE", filter: clahe, category: "Color", description: "Alpha-aware contrast-limited adaptive histogram equalization with interpolated local mappings" },
  ...
  { displayName: "Color halftone (RGB)", filter: colorHalftoneSeparate, category: "Color", description: "Area-calibrated additive RGB dot plates with independent registration offsets" },
  ...
  { displayName: "Duplex / Offset Print", filter: duplexPrint, category: "Color", description: "Sequential accent and dark ink plates clear through continuous tone into visible paper highlights" },
  ...
  { displayName: "CMYK halftone", filter: cmykHalftone, category: "Stylize", description: "Idealized unprofiled CMYK AM screens with independent plate angles" },
  { displayName: "Contour lines", filter: contourLines, category: "Stylize", description: "Antialiased topographic isolines and flat endpoint-preserving luminance bands" },
  ...
  { displayName: "Delaunay triangulation", filter: delaunay, category: "Stylize", description: "Full-frame low-poly triangle mesh with deterministic edge-weighted point placement" },
  { displayName: "Dot matrix", filter: dotMatrix, category: "Stylize", description: "Fixed circular printer-pin strikes with ordered tone density and ink/paper colors" },
  { displayName: "Edge trace", filter: edgeTrace, category: "Stylize", description: "Canny-like localized edge tracing with continuous line width and configurable color" },
  ...
  { displayName: "K-means", filter: kmeans, category: "Stylize", description: "Seeded alpha-aware color clustering with perceptual Lab or legacy RGB distance" },
  ...
  { displayName: "Mezzotint", filter: mezzotint, category: "Stylize", description: "Dark-ground tonal intaglio with crossed rocker burr, scraped light, ink, paper, and plate wear" },
  { displayName: "Mosaic tile", filter: mosaicTile, category: "Stylize", description: "Alpha-aware sampled tile colors with grout lines and per-tile brightness variation" },
  { displayName: "Oil painting", filter: oilPainting, category: "Stylize", description: "Choose modal local paint colors from circular luminance neighborhoods" },
  { displayName: "Pencil sketch", filter: pencilSketch, category: "Stylize", description: "Directional graphite hatching that follows image tone and edge flow" },
  ...
  { displayName: "Pixel outline", filter: pixelOutline, category: "Stylize", description: "Alpha-aware sprite borders around sharp color and silhouette changes" },
  ...
  { displayName: "Facet / Crystalize Grid", filter: facet, category: "Stylize", description: "Seeded faceted planes with antialiased seams and center or local-mean color" },
  { displayName: "Halftone Line", filter: halftoneLine, category: "Stylize", description: "Render tone-calibrated periodic line screens with constant, luminance, or edge-following angles" },
  { displayName: "Pop art", filter: popArt, category: "Stylize", description: "Area-correct rotatable Ben-Day dots with posterized color and configurable paper" },
  ...
  { displayName: "Risograph", filter: risograph, category: "Stylize", description: "Fixed two-master stencil print with spot inks, registration offset, correlated ink variation, and controllable bleed" },
  ...
  { displayName: "Stained glass", filter: stainedGlass, category: "Stylize", description: "Voronoi panes with average, median, or dominant visible color and anti-aliased lead came" },
  ...
  { displayName: "Voronoi", filter: voronoi, category: "Stylize", description: "Seeded exact Voronoi regions filled with alpha-aware average source colors" },
  { displayName: "Watercolor bleed", filter: watercolorBleed, category: "Stylize", description: "Stylized eight-neighbor pigment diffusion with edge deposition and multiscale paper fibers" },
  ...
  { displayName: "Cyanotype", filter: cyanotype, category: "Stylize", description: "Washed cyanotype paper with bounded Prussian-blue image density, granulation, and directional fibers" },
  ...
  { displayName: "Lens flare", filter: lensFlare, category: "Distort", description: "Linear-light bloom, anamorphic streaking, and chromatic optical-axis ghosts" },
  ...
  { displayName: "JPEG artifact", filter: jpegArtifact, category: "Glitch", description: "Apply padded 8×8 DCT compression with separate luma/chroma quality and real 4:4:4, 4:2:2, or 4:2:0 sampling" },
  ...
  // ── Simulate ──
  { displayName: "Anisotropic diffusion", filter: anisotropicDiffusion, category: "Advanced", description: "Half-float Perona–Malik smoothing with shared color-edge guidance" },
  { displayName: "Anaglyph 3D", filter: anaglyph, category: "Simulate", description: "Single-image synthetic stereo anaglyph with convergence-centered disparity and a linear-light Dubois red/cyan projection" },
  ...
  { displayName: "Bayer Sensor", filter: bayerSensor, category: "Simulate", description: "Bayer CFA capture with true nearest/bilinear or 5×5 gradient-corrected demosaicing, shot/read noise, crosstalk, optical low-pass filtering, and stable defects" },
  ...
  { displayName: "CCD Charge Smear", filter: ccdChargeSmear, category: "Simulate", description: "Visible-light proxy for CCD full-well overflow with additive column blooming and an anti-blooming drain" },
  ...
  { displayName: "Daguerreotype", filter: daguerreotype, category: "Simulate", description: "Highly detailed direct-positive particles over a directional, mirror-polished silver plate" },
  { displayName: "Digicam Flash", filter: digicamFlash, category: "Simulate", description: "Flat-scene point-and-shoot flash proxy with linear-light ambient/flash exposure, an off-axis beam, flash-only white balance, lens falloff, and sensor saturation" },
  ...
  { displayName: "E-ink (grayscale)", filter: eink, category: "Simulate", description: "Carta-style reflective display with 16 optical states, fixed paper grain, full clearing waveforms, and changed-pixel partial-update residuals" },
  ...
  { displayName: "Film burn", filter: filmBurn, category: "Simulate", description: "Projection-gate heat damage with warped dyes, blistered crust, cracked emulsion, and exposed-lamp cores" },
  { displayName: "Film grain", filter: filmGrain, category: "Stylize", description: "Density-aware film granularity with smooth clusters, correlated color layers, and optional frame motion" },
  { displayName: "Ink Bleed", filter: inkBleed, category: "Simulate", description: "Dark ink wicks through an anisotropic paper-fiber field with heterogeneous capillary edges" },
  { displayName: "Paper Texture", filter: paperTexture, category: "Simulate", description: "Antialiased paper fibres, alternating canvas and linen weave, kraft liner, or parchment formation over the image" },
  { displayName: "Sumi-e", filter: sumiE, category: "Stylize", description: "Stylized Japanese ink wash with softened tonal bands, contour ink, and directionally fibrous washi formation" },
  ...
  { displayName: "Infrared photography", filter: infrared, category: "Simulate", description: "Estimated visible-RGB infrared film response with Wood-effect monochrome and Aerochrome-style channel mapping" },
  { displayName: "LCD display", filter: lcdDisplay, category: "Simulate", description: "Magnified display-emitter proxy with equal RGB stripe, shared-chroma PenTile RGBG, and diamond-shaped RGBG layouts" },
  { displayName: "Lenticular", filter: lenticular, category: "Simulate", description: "Single-image lenticular-sheet proxy with synthetic interlaced views, viewing-angle selection, cylindrical transmission, and crosstalk" },
  { displayName: "Laser Speckle Projector", filter: laserSpeckleProjector, category: "Simulate", description: "Linear-light laser-projector irradiance with coherent speckle, independent-pattern diversity, scan structure, and optical bloom" },
  { displayName: "Light leak", filter: lightLeak, category: "Simulate", description: "Spectrally faithful edge-entering film fog added as linear-light exposure" },
  { displayName: "Mavica FD7", filter: mavicaFd7, category: "Simulate", description: "Sony MVC-FD7 still-camera proxy with VGA CCD sampling, interlaced field capture, period JPEG budgets, scene modes, and optional flash artifacts" },
  ...
  { displayName: "Moiré / Aliasing", filter: moireAliasing, category: "Simulate", description: "Lattice-derived capture aliasing from rotated scene sampling, RGB display emitters, or conventional CMYK print screens" },
  { displayName: "Newspaper", filter: newspaper, category: "Simulate", description: "Static 45° monochrome halftone with locally averaged tone, yellowed paper, folds, and fixed ink spread" },
  { displayName: "Night vision", filter: nightVision, category: "Simulate", description: "Visible-luminance image-intensifier proxy with MCP-like gain, signal-dependent noise, green phosphor bloom, and tube vignette" },
  { displayName: "Nokia LCD", filter: nokiaLcd, category: "Simulate", description: "PCD8544-style 84×48 two-state LCD with display-grid ordered dithering and preserved green optical states" },
  { displayName: "Oscilloscope", filter: oscilloscope, category: "Simulate", description: "Image-derived luma waveform, column trace, or RGB parade rendered as a persistent phosphor instrument display" },
  ...
  { displayName: "Photocopier", filter: photocopier, category: "Simulate", description: "Fixed-sheet xerographic copy with continuous density transfer, edge toner, background scatter, and transfer voids" },
  { displayName: "Polaroid", filter: polaroid, category: "Simulate", description: "Developed instant-film grade with warm dye balance, lifted blacks, fixed grain, and optical vignetting" },
  { displayName: "Projection film", filter: projectionFilm, category: "Simulate", description: "Mechanical 16/35 mm projection with weave, density grain, dark gate debris, scratches, flicker, and bloom" },
  ...
  { displayName: "Spectrogram", filter: spectrogram, category: "Simulate", description: "Spatial-frequency spectrogram treating each image column as a Hann-windowed signal with fixed-reference dB magnitude and linear or log frequency spacing" },
  {
  ...
  { displayName: "Thermal camera", filter: thermalCamera, category: "Simulate", description: "Visible-RGB luminance proxy—not emitted-IR temperature—through a low-resolution thermal-camera display" },
  { displayName: "Thermal printer", filter: thermalPrinter, category: "Simulate", description: "Direct-thermal receipt print with coherent line-head dots, density response, and edge fade" },
  { displayName: "Ultrasound", filter: ultrasound, category: "Simulate", description: "Source-derived acoustic-impedance proxy rendered as a convex B-mode sector with boundary echoes, depth attenuation, and correlated speckle" },
  ...
  { displayName: "Vintage TV", filter: vintageTV, category: "Simulate", description: "Conventional 525/625-line receiver with separate luma/chroma bandwidth, tuning error, vertical hold, interlaced raster, interference, and phosphor bloom" },
