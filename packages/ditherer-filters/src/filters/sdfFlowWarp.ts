...
export const optionTypes = {
  ...
  threshold: {
    ...
    step: 0.01,
    default: 0.5,
    desc: "Luminance threshold defining the guiding silhouette",
  },
  strength: {
    type: RANGE,
    range: [-120, 120],
    step: 1,
    default: 20,
    desc: "Signed displacement distance in pixels",
  },
  frequency: {
    type: RANGE,
    range: [2, 120],
    step: 1,
    default: 24,
    desc: "Spacing of waves across signed-distance levels",
  },
  edgeRange: {
    type: RANGE,
    range: [2, 400],
    step: 2,
    default: 120,
    desc: "Distance over which the boundary vector field remains influential",
  },
  twist: {
    type: RANGE,
    range: [0.25, 6],
    step: 0.25,
    default: 2,
    desc: "Normal-to-tangent weaving frequency in vortex mode",
  },
  animateSpeed: {
    type: RANGE,
    range: [0, 4],
    step: 0.05,
    default: 0.6,
    desc: "Speed at which field waves travel",
  },
};
