...
export const optionTypes = {
  targetHue: {
    ...
    step: 1,
    default: 0,
    desc: "Hue family to preserve in degrees",
  },
  hueWidth: {
    type: RANGE,
    range: [5, 180],
    step: 1,
    default: 25,
    desc: "Half-width of the protected hue band",
  },
  desaturateOthers: {
    type: RANGE,
    range: [0, 1],
    step: 0.05,
    default: 1,
    desc: "How much to mute colors outside the selected hue band",
  },
  softness: {
    type: RANGE,
    range: [0, 1],
    step: 0.05,
    default: 0.25,
    desc: "Soft falloff around the hue band edge",
  },
};
