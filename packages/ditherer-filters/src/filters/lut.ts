...
export const optionTypes = {
  ...
  strength: {
    ...
    step: 0.05,
    default: 1,
    desc: "Blend/overshoot toward graded image (0 = source, 1 = fully graded, >1 = push past grade for extreme looks)",
  },
  exposure: {
    type: RANGE,
    range: [-5, 5],
    step: 0.1,
    default: 0,
    desc: "Pre-grade exposure in stops (2^exposure multiplier)",
  },
...
export default defineFilter({
  ...
  defaults,
  description:
    "Colour grading lookup with iconic tonemaps (ACES, Reinhard, Hable) and film styles (Teal & Orange, Bleach Bypass, Kodachrome, Technicolor, Cross Process, Matrix Green, Amber Noir, Faded Film, Cold Winter)",
  requiresGL: true,
});
