...
describe("anamorphic cylinder radial map", () => {
  it("maps the annulus LINEARLY (reflection), not logarithmically", () => {
    ...
    const s1 =
      anamorphAnnulusHeight(cylR + 100, cylR, maxR) - anamorphAnnulusHeight(cylR + 200, cylR, maxR);
    const s2 =
      anamorphAnnulusHeight(cylR + 200, cylR, maxR) - anamorphAnnulusHeight(cylR + 300, cylR, maxR);
