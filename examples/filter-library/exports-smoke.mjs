...
if (catalog.filterCatalog.length !== root.filterList.length)
  throw new Error("Metadata catalog is incomplete");
if (lazy.lazyFilterNames.length !== Object.keys(root.filterIndex).length)
  throw new Error("Lazy registry is incomplete");
if ((await lazy.loadFilter("Grayscale")).name !== "Grayscale")
  throw new Error("Lazy loading failed");
if (grayscale.default.name !== "Grayscale") throw new Error("Per-filter export failed");
if (typeof root.createFilterSession !== "function")
  throw new Error("Root runtime export is missing");
if (typeof client.workerRPC !== "function") throw new Error("Client export is missing");
if (typeof client.disposeFilterWorker !== "function")
  throw new Error("Worker cleanup export is missing");
if (typeof worker.runWorkerFilterRequest !== "function")
  throw new Error("Worker export is missing");
