...
import { rgba, colorDistance } from "@src/util";

import type { ColorRGBA, ColorDistanceAlgorithm } from "@src/types";
...
const defaults = {
  ...
  colorDistanceAlgorithm: optionTypes.colorDistanceAlgorithm
    .default as ColorDistanceAlgorithm,
};
