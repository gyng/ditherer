...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_027ed2e9836e92ea9c1eecba8ddc10bc32a7e6ea": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){Module.exports.rgba2laba = ($1);})());
            },
            "pow": function($0, $1) {
                return Math.pow( $0, $1 );
            },
    ...
    if( Module.nodejs ) {
        ...
        const __promise = fetch( "rgba2laba.wasm" )
