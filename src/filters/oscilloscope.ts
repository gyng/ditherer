...
export const optionTypes = {
  ...
  threshold: { type: RANGE, range: [0, 255], step: 1, default: 80 },
  intensity: { type: RANGE, range: [0.5, 4], step: 0.1, default: 1.5 },
  bloom: { type: RANGE, range: [0, 10], step: 1, default: 3 },
  bloomStrength: { type: RANGE, range: [0, 3], step: 0.05, default: 0.8 },
  persistence: { type: RANGE, range: [0, 1], step: 0.01, default: 0.5 },
  graticule: { type: BOOL, default: true },
  graticuleDivs: { type: RANGE, range: [4, 16], step: 1, default: 8 },
  scanlines: { type: BOOL, default: true },
  scanlineSpacing: { type: RANGE, range: [2, 8], step: 1, default: 3 },
  noiseFloor: { type: RANGE, range: [0, 0.1], step: 0.005, default: 0.015 },
