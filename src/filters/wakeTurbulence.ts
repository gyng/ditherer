...
export default defineFilter({ name: "Wake Turbulence", func: wakeTurbulence, optionTypes, options: defaults, defaults, description: "Moving objects leave rippling distortion in their wake — heat shimmer effect" , temporal: true });
