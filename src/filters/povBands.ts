...
export default defineFilter({ name: "POV Bands", func: povBands, optionTypes, options: defaults, defaults, description: "Split the frame into horizontal bands that each show a different recent moment in time" , temporal: true });
