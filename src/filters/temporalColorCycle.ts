...
export default { name: "Temporal Color Cycle", func: temporalColorCycle, optionTypes, options: defaults, defaults, description: "Hue rotates over time — moving areas cycle faster creating rainbow trails" };
