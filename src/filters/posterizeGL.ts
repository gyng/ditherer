...
// Per-channel posterise. Matches the JS reference's two-round-trip
// quantisation math (round to nearest band, then round to integer).
...
export const posterizeGLAvailable = (): boolean => glAvailable();
