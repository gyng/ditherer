...
export default defineFilter({ name: "Video Feedback", func: videoFeedback, optionTypes, options: defaults, defaults, description: "Camera-pointing-at-monitor effect — infinite recursive tunnels and fractal patterns" , temporal: true });
