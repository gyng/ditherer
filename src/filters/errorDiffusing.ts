import {
  defaults,
  errorDiffusingFilter,
  ErrorMatrix,
} from "./errorDiffusingFilterFactory";
import { scaleMatrix } from "@src/util";

// https://en.wikipedia.org/wiki/Floyd%E2%80%93Steinberg_dithering
// [_,    *,    7/16]
// [3/16, 5/16, 1/16]
const fsKernel: ErrorMatrix = {
  offset: [-1, 0], // x, y
  kernel: [
    [null, null, 7 / 16],
    [3 / 16, 5 / 16, 1 / 16],
...
const falseFsKernel: ErrorMatrix = {
  offset: [0, 0], // x, y
  kernel: scaleMatrix(
    [
      [null, 3],
...
//     2   3   2
//       (1/32)
const sierra3kernel: ErrorMatrix = {
  offset: [-2, 0], // x, y
  kernel: scaleMatrix(
    [
      [null, null, null, 5, 3],
...
// 1   2   3   2   1
//       (1/16)
export const sierra2kernel: ErrorMatrix = {
  offset: [-2, 0], // x, y
  kernel: scaleMatrix(
    [
      [null, null, null, 4, 3],
...
// 1   1
//   (1/4)
export const sierraLiteKernel: ErrorMatrix = {
  offset: [-1, 0], // x, y
  kernel: scaleMatrix(
    [
      [null, null, 2],
...
//     1
//   (1/8)
const atkinsonKernel: ErrorMatrix = {
  offset: [-1, 0], // x, y
  kernel: scaleMatrix(
    [
      [null, null, 1, 1],
...
// 1   3   5   3   1
//       (1/48)
const jarvisKernel: ErrorMatrix = {
  offset: [-2, 0], // x, y
  kernel: scaleMatrix(
    [
      [null, null, null, 7, 5],
...
// 2   4   8   4   2
// 1   2   4   2   1   (1/42)
const stuckiKernel: ErrorMatrix = {
  offset: [-2, 0],
  kernel: scaleMatrix(
    [
      [null, null, null, 8, 4],
...
// 2   4   8   4   2   (1/32)
const burkesKernel: ErrorMatrix = {
  offset: [-2, 0],
  kernel: scaleMatrix(
    [
      [null, null, null, 8, 4],
...
//   1
//   (1/4)
const horizontalStripeKernel: ErrorMatrix = {
  offset: [0, 0], // x, y
...
const verticalStripeKernel: ErrorMatrix = {
  offset: [0, 0], // x, y
  kernel: scaleMatrix([[null, 1, null, 1]], 1 / 4),
};
