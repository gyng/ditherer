...
export type SurfaceApply<TPixel> = (
  px: TPixel,
  x: number,
  y: number,
  idx: number
...
export type SurfaceApplyMut<TPixel> = (
  px: TPixel,
  x: number,
  y: number,
  idx: number
...
export abstract class BaseSurface<TPixel, TBuffer> {
  ...
  abstract apply(fn: SurfaceApply<TPixel>): void;
  abstract applyMut(fn: SurfaceApplyMut<TPixel>): void;
